...
def main():
    ...
    html_temp = """
	<div style="background-color:tomato;"><p style="color:white;font-size:40px;padding:9px">Twitter Sentiment analysis</p></div>
	"""
    ...
    st.sidebar.info("ajethwani000@gmail.com")
